...
import chapter20.tankgame3_2.shot.EnemyShot;
import chapter20.tankgame3_2.shot.HeroShot;
import chapter20.tankgame3_2.shot.ShotParent;
import chapter20.tankgame3_2.tank.EnemyTank;
import chapter20.tankgame3_2.tank.HeroTank;
import chapter20.tankgame3_2.tank.TankParent;
                ...
                if (heroShot != null && heroShot.isLive()) {
                    ...
                    for (int j = 0; j < mEnemyTanks.size(); j++) {
                        ...
                        if (tankIsShoted) {
                            ...
                            Recorder.getInstance().setDeadTankNum();
                            break;
                        }
                    }
                } else {
