package chapter20.tankgame3_1.shot;

import chapter20.tankgame3_1.Constants;

/**
 * Project: HspBase
 * Create By: ChenFuXu
 * DateTime: 2023/5/17 23:12
 *
 * 我方坦克子弹射击类
 **/
public class HeroShot extends ShotParent {
    public HeroShot(int x, int y, int direction) {
        super(x, y, direction);
    }

    @Override
    protected void initType() {
        mType = Constants.TYPE_HERO_BULLET;
    }

    @Override
    protected void initSpeed() {
        mSpeed = Constants.SPEED_HERO_SHOT;
    }
